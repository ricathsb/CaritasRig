    ...
    Box(
        ...
        Column {
            ...
            Surface(
                ...
                MotherboardList(motherboards = motherboards, navController)
            }
        }
...
//                        val socketMatch = selectedSockets.isEmpty() || motherboard.socketCpu in selectedSockets
////                        val memoryMatch = motherboard.memoryMax <= maxMemory
...
@Composable
fun MotherboardList(motherboards: List<MotherboardBuild>, navController: NavController) {
