    ...
    Box(modifier = Modifier.fillMaxSize()) {
        ...
        Column {
            ...
            Surface(modifier = Modifier.fillMaxSize(), color = Color.Transparent) {
                InternalHardDriveList(internalHardDrives = allHardDrives, navController)
            }
        }
    }
}
...
@Composable
fun InternalHardDriveList(internalHardDrives: List<InternalHardDriveBuild>, navController: NavController) {
    ...
    LazyColumn(
        ...
        items(internalHardDrives) { hardDrive ->
            ...
            ComponentCard(
                ...
                details = "Capacity: ${hardDrive.capacity}GB | Price per GB: \$${hardDrive.formFactor} | Type: ${hardDrive.type} | Cache: ${hardDrive.cache}MB | Form Factor: ${hardDrive.formFactor} | Interface: ${hardDrive.interfaceType}",
