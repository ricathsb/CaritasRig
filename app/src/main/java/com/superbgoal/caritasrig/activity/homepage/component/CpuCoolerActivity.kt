...
class CpuCoolerActivity : ComponentActivity() {
                    ...
                    Column {
                        TopAppBar(
                            ...
                            actions = {
                                IconButton(
                                    onClick = {
                                        // Action for filter button (to be implemented if required)
                                    },
    ...
    @Composable
    fun CpuCoolerList(cpuCoolers: List<CpuCooler>) {
                            ...
                            saveComponent(
                                ...
                                onSuccess = {
                                    ...
                                    val intent = Intent(context, BuildActivity::class.java).apply {
                                        putExtra("component_title", coolerItem.name)
                                        putExtra("component_data", coolerItem) // Component sent as Parcelable
                                    }
